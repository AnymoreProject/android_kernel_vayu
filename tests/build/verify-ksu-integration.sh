...
require_contains "patches/KernelSU-Next/0003-linux-4.14-seccomp-cache.patch" \
  "Linux 4.14 has no seccomp action cache to mutate"
...
require_contains "include/linux/susfs_def.h" "#include <linux/cred.h>"
require_contains "include/linux/susfs_def.h" "__kuid_val(current_uid()) >= 10000);"
...
require_contains "scripts/prepare-ksu-susfs.sh" "expected_twa_resume_uses=2"
require_contains "scripts/prepare-ksu-susfs.sh" "s/TWA_RESUME/true/g"
